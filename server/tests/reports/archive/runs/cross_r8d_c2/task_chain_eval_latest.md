...
| producer产出率 | produces 标注的步实际回传新 ID 的比例 | 0.0000 |
...
| 平均耗时(ms) | 单链端到端 | 201983.3 |
| P50/P95(ms) | | 201983.3 / 201983.3 |
| 总耗时(s) | | 202.0 |
...
- 定位 0.50 | 覆盖 0.50 | 精准 0.00 | 引用一致 0.00 (0/1) | producer产出 0/2
- 多余写入 1 (异表 0) | 耗时 201983ms
