...
| 平均多余写入 | 未被 expected 认领的行改动 | 1.3333 |
| 平均异表写入 | 写到 expected 之外的表 | 0.0000 |
| 平均耗时(ms) | 单链端到端 | 53148.7 |
| P50/P95(ms) | | 50994.1 / 65480.3 |
| 总耗时(s) | | 159.4 |
...
- 多余写入 1 (异表 0) | 耗时 50994ms
- 错误: 失败：match_field - 未找到列[列引用]
